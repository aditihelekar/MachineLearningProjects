# -*- coding: utf-8 -*-
"""
Created on Sun Apr 16 15:10:59 2017
...
#os.chdir('E:\\ComputerScience\\Sem2\\ML\\Project\\uber-pickups-in-new-york-city')
...
#uberplt = plt.scatter(uberplot["Lat"],uberplot["Lon"],color='r',label="Uber")
#lyftplt = plt.scatter(lyftplot["Lat"],lyftplot["Lon"],color='b',label="Lyft")
#plt.scatter(centroids[:, 0], centroids[:, 1],marker='x', s=169, linewidths=3,color='green', zorder=10)
...
#for i in centroids: plt.plot( [0, len(ubercleanData)-1],[i,i], "k" )
#for i in range(len(ubercleanData)):
#    plt.plot(ubercleanData["Lat"][i], ubercleanData["Lon"][i], colors[labels[i]], markersize = 10)
#plt.show()